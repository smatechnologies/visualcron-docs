...
To use a specific cloud service you need to create a [Connection](../../global-connections) first. Click the *Settings* icon to open the *Manage Connections* dialog. Only cloud connections (Amazon S3, Windows Azure, OneDrive, Google Drive, Dropbox, Box, Google Storage) are listed; Azure Management connections are excluded.
