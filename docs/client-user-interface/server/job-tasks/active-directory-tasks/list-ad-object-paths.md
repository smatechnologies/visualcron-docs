...
**Get Active Directory object using:**

Select how to retrieve the Active Directory object's LDAP paths.
...
Enter a custom query statement using SQL or LDAP syntax to filter results.
